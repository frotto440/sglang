...
class ServerArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            type=float,
            default=ServerArgs.memory_safety_margin,
            help="Fraction of available GPU memory to use for batching (0.0-1.0). "
            "Lower values are more conservative but may reduce batch sizes.",
        )
